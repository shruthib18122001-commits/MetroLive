...
export function StopRoute() {
  ...
  return (
    <div className="animate-fade-in">
      <div className="-mx-4 -mt-5 rounded-b-3xl bg-gradient-to-b from-brand-800 to-brand-900 px-4 pb-6 pt-4 text-white shadow-hero">
        <Link
          to="/"
          className="inline-flex w-fit items-center gap-1 rounded-lg py-0.5 text-sm font-medium text-brand-200 transition-colors hover:text-white focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-brand-900"
        >
        ...
        <div className="mt-3 flex items-start justify-between gap-3">
          <div className="min-w-0">
            <h1 className="text-[1.375rem] font-bold leading-snug tracking-[-0.01em] text-white">
              {stopName}
            </h1>
            <p className="mt-1 text-[0.8125rem] text-brand-200">
              Stop {stopId}
          ...
          <FavoriteToggle
            ...
            className="mt-0.5 shrink-0 focus-visible:ring-offset-brand-900"
          />
        </div>
      </div>
      ...
      <div className="mt-5 flex flex-col gap-4">
        {source === 'demo' ? (
          <p
            role="note"
            className="flex items-start gap-2 rounded-xl border border-sky-200 bg-sky-50 px-3.5 py-2.5 text-[0.8125rem] leading-relaxed text-sky-900"
          >
        ...
        <div className="flex items-center justify-between px-1 text-xs text-neutral-600">
          ...
          <button
            ...
            className="inline-flex items-center gap-1 rounded-md px-2 py-1 font-semibold text-brand-700 transition-colors hover:bg-brand-100 focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-2"
          >
