        ...
        {favorites.map((favorite) => (
          <li key={favorite.id} className="flex items-stretch gap-2">
            ...
            <button
              ...
              className="tap-target rounded-xl border border-neutral-300 bg-white px-3 text-neutral-600 hover:bg-neutral-50 focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-2"
            >
