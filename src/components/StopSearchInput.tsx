    ...
    <div>
      ...
      <div className="relative mt-1">
        <input
          ...
          className="tap-target w-full rounded-lg border border-neutral-300 bg-white px-3 pr-10 text-base text-neutral-900 placeholder:text-neutral-500 focus-visible:border-brand-600 focus-visible:ring-2 focus-visible:ring-brand-600"
        />
        {value ? (
          <button
            type="button"
            ...
            className="tap-target absolute inset-y-0 right-0 flex items-center justify-center px-3 text-neutral-600 hover:text-neutral-800"
          >
